            ...
            <div class="map-content-9 py-5" id="contact">
                <div class="map-content-9-in">
                    <div class="w3-map-content-9-form">
                        ...
                        <form action="{{'/technician_complaint_insert'}}" method="post">
                            {{csrf_field()}}
                            <div class="twice-two">
                                <input type="hidden" name="technician_id" value="{{$complaint->tech_id}}" id="">
                                <input type="text" class="form-control" readonly name="name" id="w3lName" placeholder="Name" value="{{$complaint->tech_name}}" >
                                <input type="email" class="form-control" readonly name="email" id="w3lSender" placeholder="Email" value="{{$complaint->tech_email}}" >
                            </div>
                            <div class="twice">
