...
<head>
	...
	<style type="text/css">
		...
		<div id="box" class="col-md-4">
				<h3>Technician Login Form</h3><br>
			<form id="form" method="post"  required action="{{'/technician_login_insert'}}">
				{{csrf_field()}}
			...
			color: var(--primary-color);" href="{{'/technician_register'}}">Click Here To Register..</a><br><br>
