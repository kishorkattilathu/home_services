...
<head>
	...
	<style type="text/css">
		...
		<div id="box" class="col-md-4" style="background-color:white;">
			...
			<form id="form" method="post" action="{{'/customer_login_insert'}}">
				{{csrf_field()}}
			...
			color: var(--primary-color);" href="{{'/customer_register'}}">Click Here To Register..</a><br><br>
					<a style="margin-left: 120px;
			color: var(--primary-color);" href="{{'/index'}}"><span class="fa fa-home fa-2x" style="color: var(--primary-color);"></span>
            </a>
			</form>
